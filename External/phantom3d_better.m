function [p,ellipse]=phantom3d_better(varargin)
...
%
% Modified by Tiago Ramos (tiagoj@dtu.dk) March-2017
% The psi collumn was set to 0 so the central slice of the 3D phantom
% resembles MATLAB's Shepp Logan's phantom (see function 'phantom')[ellipse,n] = parse_inputs(varargin{:});
...
% Modified by Tiago Ramos (tiagoj@dtu.dk) March-2017
% The psi collumn was set to 0 so the central slice of the 3D phantom
% resembles MATLAB's Shepp Logan's phantom (see function 'phantom')
%         A      a     b     c     x0      y0      z0    phi  theta    psi
%        -----------------------------------------------------------------
e =    [  1  .6900  .920  .810      0       0       0      0      0      0              %,810 ,78 ,22 ,28 ,41 ,05 ,05 ,05 ,02 ,02
        -.8  .6624  .874  .780      0  -.0184       0      0      0      0
        -.2  .1100  .310  .220    .22       0       0    -18      0      0
        -.2  .1600  .410  .280   -.22       0       0     18      0      0
